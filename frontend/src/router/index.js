...
const routes = [
    ...
    { path: '/unauthorized', name: 'UnauthorizedView', component: UnauthorizedView },
    {
        ...
        children: [
            { path: '/home-view', name: 'HomeView', component: HomeView, meta: {allowedPositions: ['Employer', 'Employee', 'Payroll Manager', 'Supervisor', 'SoftwareManager']} },
            { path: '/add-employee', name: 'AddEmployee', component: AddEmployee, meta: {allowedPositions: ['Employer']} },
            { path: '/view-employee-profile/:id', name: 'ViewEmployeeProfile', component: ViewEmployeeProfile, meta: {allowedPositions: ['Employer']} },
            { path: '/view-companies-list', name: 'ViewCompaniesList', component: ViewCompaniesList, meta: {allowedPositions: ['SoftwareManager']} },
            { path: '/employees-list', name: 'EmployeesList', component: EmployeesList, meta: {allowedPositions: ['Employer']} },
            { path: '/view-employee-profile-employer/:id', name: 'ViewEmployeeProfileEmployer', component: ViewEmployeeProfileEmployer, meta: {allowedPositions: ['Employer']} },
            ...
            { path: '/select-change-benefit', name: 'SelectChangeBenefit', component: SelectChangeBenefit, meta: {allowedPositions: ['Employer', 'Employee']} },
            { path: '/view-employee-profile', name: 'ViewEmployeeProfile', component: ViewEmployeeProfile, meta: {allowedPositions: ['Employer', 'Employee', "Payroll Manager","Supervisor", "SoftwareManager"]}},
