...
{
    /// <summary>
    /// Repository for managing operations related to the PayrollManagers table.
    /// </summary>
    public class PayrollManagerRepository
    {
        ...
        /// </summary>
        public PayrollManagerRepository()
        {
        ...
        /// <summary>
        /// Inserts a new payroll manager into the PayrollManagers table.
        /// </summary>
        /// <param name="payrollManager">The payroll manager model containing the data to insert.</param>
        public void CreatePayrollManager(PayrollManagerModel payrollManager)
        {
            // SQL query to insert a new payroll manager
            var query = @"
            ...
            using (var command = new SqlCommand(query, _connection))
            {
                ...
                command.Parameters.AddWithValue("@Id", payrollManager.Id);
